...
def extract_method_vuln_code(row):
    ...
    vul_lines = np.asarray([int(line) for line in str(row["vul_line"]).split()]) - 1
...
filename = "C:/Users/Admin/Desktop/FVA-master/Data/function_level_Le_Data/data.xlsx"
